    ...
    with col2:
        ...
        <div style="text-align:center;margin-bottom:24px;">
            <img src="data:image/png;base64,{LOGO_B64}"
                 style="width:100px;filter:drop-shadow(0 0 12px #E8560A66);">
...
<div class="header">
    ...
    <p>{row.get("Verein","—")} · {row.get("Liga","—")} · {pos_cfg.get("de",position)} · {int(row.get("Alter",0) or 0)} J. · {int(row.get("Minuten",0) or 0)} min</p>
...
with st.sidebar:
    ...
    <div style="text-align:center;padding:20px 0 14px;">
        <img src="data:image/png;base64,{LOGO_B64_VAR}"
             style="width:90px;filter:drop-shadow(0 0 14px {ORG}88);">
